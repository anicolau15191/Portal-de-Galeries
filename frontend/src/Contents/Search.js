...
class Search extends Component {
    ...
    componentDidMount() {
        axios.get("https://api.artgalleryxisca.me/poblacio")
            .then(res => {
                const poblacio = res.data;
                this.setState({ poblacio });
            })
        axios.get("https://api.artgalleryxisca.me/generes")
            .then(res => {
                const genPare = res.data;
                this.setState({ genPare });

            })
        axios.get("https://api.artgalleryxisca.me/generes/subgeneres")
            .then(res => {
