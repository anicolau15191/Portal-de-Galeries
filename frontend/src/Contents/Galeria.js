    ...
    return (
      <Suspense fallback={renderLoader()}>
        <div className='galeria'>
          ...
          <Container id='info' className='d-flex justify-content-md-center mb-lg-3'>
            <Row>
              ...
              <Col>
                <Row>
                  ...
                  <Col className='col-12 mt-1 d-flex flex-column justify-content-start d-flex flex-lg-row'>
                  ...
                  <Col md="12" lg="6" className=' d-flex justify-content-md-center flex-column  mt-3'>
                  ...
                  <Col className='d-flex justify-content-md-center col-12 mt-2 mb-3 mb-lg-0'>
