...
class Footer extends Component {
    ...
    render() {
        return (
            <footer >
                <div className="text-center text-lg-start bg-dark text-white mt-5">
                    <section className="p-4 border-bottom">
                        <div className=" d-md-flex justify-content-center ">
                            <a href="https://twitter.com/?lang=en" className="me-4 text-reset text-decoration-none">
                    ...
                    <section>
                        <div class="container text-center text-md-start mt-5">
                            <div class="row mt-3">
                                <div class="col-12 col-md-4 text-star">
                                    <div class="mb-2">
                                    ...
                                    </svg> Carrer Gremi de Traginers</p>
                                    ...
                                    </svg> 07009 Palma , Illes Balears</p>
                                    ...
                                    </svg> artGallery@gmail.com</p>
                                </div>
                                <hr class=" d-md-none"></hr>
                                <div class="col-12 col-md-4 mb-4 text-star">

                                    <p class=" mb-4 ">VARIS </p>
                                ...
                                <div class="col-12 col-md-4 mb-4 text-star">
                                    ...
                                    <p><a href="#!" class="text-reset text-decoration-none d-md-block">Política de Privacidad</a></p>
                                    <p> <a href="#!" class="text-reset text-decoration-none d-md-block">Acerca de Art Gallery</a></p>
                                    <p> <a href="#!" class="text-reset text-decoration-none  d-md-block">Política de Cookies</a></p>
                                </div>
                            </div>
                        </div>
                    </section>
